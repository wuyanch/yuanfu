<template>
  <div class="oto-index" vkshop-event-scope="我的员福首页">
    ...
    <div class="main">
      ...
      <!-- 是否关注 -->
      <div class="is-follow" v-if="haveEnterprise">
...
export default {
  ...
  data () {
    return {
     ...
     isAttention: localStorage.getItem('YF_mainstream_project_isAttention')==null?0:localStorage.getItem('YF_mainstream_project_isAttention'),//是否关注
     proname:'您还没有项目，请先去创建项目哦~',//项目名称
     variousPremiums:[
